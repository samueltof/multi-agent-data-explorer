...
def prepare_data_query_node(state: AgentState) -> AgentState:
    ...
    logger.info("👨‍💻 DATA TEAM: Preparing query...")
    ...
    # Log the found query
    logger.info(f"👨‍💻 DATA TEAM: Found user query: '{last_human_message.content}'")
...
""",
    ...
    # No longer need format_instructions partial variable
)
...
def fetch_schema_node(state: AgentState) -> AgentState:
    ...
    logger.info("👨‍💻 DATA TEAM: Fetching schema...")
    try:
        ...
        logger.error(f"👨‍💻 DATA TEAM: Error in fetch_schema_node: {e}")
...
def sql_generator_node(state: AgentState, llm_client: Any) -> AgentState:
    ...
    logger.info("👨‍💻 DATA TEAM: Generating SQL...")
...
def sql_executor_node(state: AgentState) -> AgentState:
    ...
    try:
        ...
        logger.info(f"👨‍💻 DATA TEAM: Execution result: {execution_result}")
...
def handle_error_node(state: AgentState) -> AgentState:
    ...
    logger.warning(f"👨‍💻 DATA TEAM: Handling error: {state.get('error_message')}")
